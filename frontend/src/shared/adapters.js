 ...
 *   - askCopilot(text, frames)  -> string        (frames: FrameItem[])
 *   - runSearch(tab, pivot)     -> Promise<{items, totalItems, latency, type, mode}>
 */
export { demoTranslate as translateText } from "../mocks/copilot.js";
export { mockChatReply as askCopilot } from "../mocks/copilot.js";
