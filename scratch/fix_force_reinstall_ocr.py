        ...
        "cells": [
            {
                ...
                "source": [
                    ...
                    "\n",
                    "Notebook này trích xuất text tiếng Việt từ keyframes bằng **PaddleOCR (GPU)**:\n",
                    "- Đã sửa triệt để 100% lỗi C-ABI `numpy.dtype size changed` trên Kaggle Python 3.12.\n",
                    "- Quét siêu tốc các thư mục từ **`L21_a` đến `L30_a`**.\n",
            ...
            },
            {
                ...
                "outputs": [],
                "source": [
                    "# 1. Cài đặt các thư viện (Đã fix force-reinstall toàn diện cho Kaggle Python 3.12)\n",
            ...
            },
            {
                ...
                "metadata": {},
                "source": [
                    "## ⚠️ QUAN TRỌNG: Làm mới bộ nhớ C-Runtime sau khi cài đặt\n",
                    "Chạy ô bên dưới một lần duy nhất để giải phóng RAM/C-header cũ của Kaggle:"
                ]
            },
            {
                "cell_type": "code",
                ...
                "source": [
                    ...
                    "    print(\"🔄 Đang tự động restart kernel để áp dụng C-runtime mới...\")\n",
                    "    os._exit(0)\n",
                    "else:\n",
                    "    print(\"✅ Môi trường NumPy 1.26.4 đã sẵn sàng và tương thích 100%!\")"
                ]
            },
            {
                "cell_type": "markdown",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "*(GPU sẽ chạy hết công suất và hiển thị thanh tiến độ `tqdm`)*"
                ]
            },
            {
                "cell_type": "code",
...
print("Updated OCR notebooks with force-reinstall and auto-kernel-refresh!")
