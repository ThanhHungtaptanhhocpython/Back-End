        ...
        "cells": [
            {
                ...
                "source": [
                    ...
                    "- Đã fix triệt để lỗi xung đột C-ABI giữa `numpy`, `scipy`, `skimage` trên Kaggle Python 3.12.\n",
            ...
            },
            {
                ...
                "outputs": [],
                "source": [
                    "# 1. Cài đặt các thư viện (Đã fix tương thích đồng bộ cho Kaggle Python 3.12)\n",
                    "# Cài numpy 1.26.4 đồng bộ cùng scipy và scikit-image tương thích để tránh lỗi C-ABI\n",
                    "!pip install -q \"numpy==1.26.4\" \"scipy==1.12.0\" \"scikit-image==0.22.0\" paddlepaddle-gpu==2.6.1 paddleocr==2.7.3 Pillow tqdm"
                ]
            },
            {
                "cell_type": "markdown",
...
print("Updated OCR notebooks with synchronized numpy, scipy and scikit-image!")
