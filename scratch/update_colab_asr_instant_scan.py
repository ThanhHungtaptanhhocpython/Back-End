...
def create_colab_asr_instant_notebook():
    nb = {
        "cells": [
            {
                "cell_type": "markdown",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "\n",
                    "# Quét thẳng vào thư mục video_batch_1 (nhanh tức thì < 1 giây)\n",
                    "search_dirs = [\n",
...
colab_asr_instant = create_colab_asr_instant_notebook()
...
with open(os.path.join(base_dir, "scripts", "notebooks", "extract_asr_colab.ipynb"), "w", encoding="utf-8") as f:
    json.dump(colab_asr_instant, f, indent=1, ensure_ascii=False)
...
print("Updated extract_asr_colab.ipynb with instant direct search_dirs scanning (< 1s)!")
