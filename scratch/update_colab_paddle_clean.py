...
def create_colab_paddleocr_clean_notebook():
    nb = {
        "cells": [
            {
                "cell_type": "markdown",
                ...
                "source": [
                    ...
                    "### 🚀 Tốc Độ ~40 - 50 FPS (~2 - 3 Phút / 1 Zip) - Tối Ưu Cho Google Colab A100 / T4 GPU\n",
                    "\n",
                    ...
                    "- 🟢 **Đã tích hợp bản vá Mocking C-ABI**: Chạy 100% không bị lỗi xung đột `numpy<2.0.0` / `skimage` trên Colab Python 3.12.\n",
            ...
            },
            {
                ...
                "metadata": {},
                "source": [
                    "## 📦 1. Cài đặt PaddlePaddle GPU & Bản vá Ổn định"
                ]
            },
            {
                "cell_type": "code",
                ...
                "outputs": [],
                "source": [
                    "# Gỡ các gói onnx không tương thích nếu có để tránh xung đột\n",
                    ...
                    "    print(f\"🚀 GPU CUDA đã được kích hoạt: {paddle.device.cuda.get_device_name(0)}\")\n",
                    "    print(\"🔥 Sẵn sàng chạy OCR với tốc độ ~40 - 50 FPS!\")"
                ]
            },
            {
                "cell_type": "markdown",
...
colab_paddle_clean = create_colab_paddleocr_clean_notebook()
...
with open(os.path.join(base_dir, "scripts", "notebooks", "extract_ocr_colab.ipynb"), "w", encoding="utf-8") as f:
    json.dump(colab_paddle_clean, f, indent=1, ensure_ascii=False)
...
print("Successfully written clean PaddleOCR GPU notebook!")
