...
def create_bulletproof_ocr_notebook():
    nb = {
        "cells": [
            {
                "cell_type": "markdown",
                ...
                "source": [
                    ...
                    "### 🎯 Kaggle GPU Edition - Đã Bypass Triệt Để Lỗi C-ABI Python 3.12\n",
                    "\n",
                    "Notebook này sử dụng **PaddleOCR (GPU)** với bản vá Mocking:\n",
                    "- **Bypass 100% lỗi xung đột C-ABI** của `skimage` trên Python 3.12.\n",
                    "- Cơ chế **Streaming trực tiếp**: GPU kích hoạt ngay từ giây đầu tiên.\n",
                    "- Tự động duyệt và lọc dải thư mục từ **`L21_a` đến `L30_a`**.\n",
            ...
            },
            {
                ...
                "outputs": [],
                "source": [
                    "# Cài đặt paddlepaddle-gpu và paddleocr\n",
            ...
            },
            {
                ...
                "metadata": {},
                "source": [
                    "## 🤖 2. Khởi tạo PaddleOCR Model trên GPU (Đã Bypass `skimage`)"
                ]
            },
            {
                "cell_type": "code",
                ...
                "source": [
                    ...
                    "\n",
                    "# BẢN VÁ: Mocking các module skimage không dùng đến để tránh lỗi C-ABI của Python 3.12\n",
                    "mock_modules = [\n",
...
ocr_bulletproof = create_bulletproof_ocr_notebook()
...
with open(os.path.join(base_dir, "scripts", "notebooks", "kaggle_new", "extract_ocr_kaggle.ipynb"), "w", encoding="utf-8") as f:
    json.dump(ocr_bulletproof, f, indent=1, ensure_ascii=False)
...
print("Updated OCR notebooks with bulletproof skimage mock!")
